...
// solução com operador ternário do Miguel Coutinho
const ordenarNotas = aprovados => aprovados.sort((a,b) => (b.nota == a.nota) ? (a.idade-b.idade) : (b.nota - a.nota));
console.log(ordenarNotas(aprovados));